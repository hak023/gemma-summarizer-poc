...
sequenceDiagram
    ...
    rect rgb(240, 245, 255)
        Note over IPC,Logger: 믿음2.0 요약 프로그램 (내부)
...
sequenceDiagram
    ...
    rect rgb(240, 245, 255)
        Note over IPC,Gemma: 믿음2.0 요약 프로그램 (내부)
...
sequenceDiagram
    ...
    Client->>IPC: 요청 전송
    rect rgb(240, 245, 255)
        Note over IPC,Postprocessor: 믿음2.0 요약 프로그램 (내부)
        IPC->>Gemma: 요약 요청
        Gemma->>IPC: JSON 응답
        IPC->>Postprocessor: 후처리 요청
...
sequenceDiagram
    ...
    rect rgb(240, 245, 255)
        Note over IPC,STTData: 믿음2.0 요약 프로그램 (내부)
...
sequenceDiagram
    ...
    rect rgb(240, 245, 255)
        Note over IPC,Fields: 믿음2.0 요약 프로그램 (내부)
